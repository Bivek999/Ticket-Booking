  ...
  return (
    <div id="seat_booking">
      <div className="premium">
        <h2 className="ticket-type-heading">Premium - Rs. 380</h2>
            ...
            <>
              {idx < 2 && (
                <div
                  key={rowitem.row}
                  className={
                    ticketType === "premium" && idx < 2
                      ? "row"
                      : ticketType === "standard" && idx > 1
                      ? "row"
                      : "row row-disable"
                  }
                >
                  ...
                  {rowitem.seats.map((rowseat) => (
                    <Seat
                      ...
                      clsname={
                        rowseat.isSelected && rowseat.status === "available"
                          ? "selected"
                          : rowseat.status
                      }
                      onclickfn={
      ...
      <div className="Standard">
        <h2 className="ticket-type-heading">Standard - Rs. 180</h2>
